...
static char szName737MAXSDK[]="iFly737MAX_SDK_FileMappingObject";
...
typedef struct ShareMemory737MAXSDK
{
	...
	BYTE		LandingLlightAlternateFlash;//0:不带Landing Lights - Alternate Flash；1：带Landing Lights - Alternate Flash
	...
	BYTE		Refuel_Power_Control_Switch_Status;//加油面板打开与否(S156)。0:Refuel Access Panel CLOSED     1:Refuel Access Panel OPEN
