-- Detlef von Reusner
-- PMDG B737-700 Overhead panel - Anti-Ice
-- FS2020
...
local gBlackMask = canvas_add(0, 0, 400, 255, function()
  _rect(0, 0, 400, 255)
  _fill("black")
end)
...
local gImgLines = canvas_add(0, 0, 400, 255, DrawAllLines)
...
function DrawAllTexts()
  ...
  PrintText("WING ANTI-ICE", 60, 154, style, 24, false)
  PrintText("ENG", 270, 154, style, 24, false)

  PrintText("1", 247, 230, style, 24, false)
  PrintText("2", 327, 230, style, 24, false)
  PrintText("+", 178, 220, style, 24, false)
  
  style = gFontPrintSmall..";color:"..gColorPrint

  PrintText("ANTI-ICE", 261, 171, style, 22, false)

  PrintText("OFF", 139, 177, style, 18, false)
  PrintText("ON", 139, 205, style, 18, false)

  PrintText("OFF", 280, 187, style, 18, false)
  PrintText("ON", 280, 215, style, 18, false)

 
end


local gImgTexts = canvas_add(0, 0, 400, 255, DrawAllTexts)

-- ===================== images above lines ================

img_add("frames.png", 0, 0, 400, 255)
...
local gBlackMask2 = canvas_add(0, 0, 400, 255, function()
  _rect(0, 0, 400, 255)
  _fill("black")
end)
